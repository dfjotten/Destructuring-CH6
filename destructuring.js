...
const refresh = product.refreshRate;
...
const wifi = tvOptions.options.connectivity.popular.wifi;
const bluetooth = tvOptions.options.connectivity.popular.bluetooth;
...
const wifi2 = connectivity[0];
const bluetooth2 = connectivity[1];

console.log(wifi2,bluetooth2)
...
const first = tvSizes[0];
const third = tvSizes[2];
...
const name3 = companyDetails.name;
const adress3 = companyDetails.adress;

console.log(name3,adress3);
...
const [string1, string2 ] = getDetails('Dan', '27');
